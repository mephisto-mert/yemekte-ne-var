      ...
      >
        ...
        <div className="relative h-48 sm:h-64 w-full bg-slate-800 flex-shrink-0 overflow-hidden">
          ...
          <div className="absolute bottom-4 left-4 right-4">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight drop-shadow-md font-heading">
              {recipe.title}
            </h2>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-slate-200">
          ...
          <RecipeDetailNavTabs hasVideo={!!recipe.videoId} />
          ...
          {/* Feature 1: Macro Nutrition Donut Ring & Breakdown */}
          <RecipeMacroDonut recipe={recipe} />

          {/* Feature 7: Chef Tasting Notes & Gourmet Pairings */}
          <RecipeChefPairing recipe={recipe} />
          ...
          <div id="recipe-section-ingredients" className="flex items-center justify-between pb-2 border-b border-slate-800">
          ...
          {/* Feature 9: 15-Second Step Visual Stories Circles & Step-by-Step Instructions */}
          <div id="recipe-section-steps">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                <span>Hazırlanış Adımları</span>
                <span className="text-xs font-normal text-slate-400">({recipe.instructions.length} adım)</span>
              </h3>
            </div>

            {/* Stories-Style Step Circles Preview Bar */}
            <RecipeStoryRings instructions={recipe.instructions} />
            ...
            <div className="space-y-3">
              {recipe.instructions.map((step, idx) => (
                <div
                  id={`recipe-step-${idx}`}
                  key={idx}
                  className="flex gap-3 p-3.5 rounded-2xl bg-slate-800/40 border border-slate-800/70 transition-all duration-300"
                >
